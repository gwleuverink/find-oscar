...
return [
    ...
    'meta' => [
        'title' => 'Missing: Oscar Huizinga, :age, last seen in Istanbul',
        'description' => 'Oscar Tristan Huizinga, a :age-year-old Dutch man, has been missing in Istanbul since Monday 3 August 2026. If you have seen him, or know anything at all, please contact the police.',
    ],

    'hero' => [
        'eyebrow' => 'Missing person',
        'headline' => 'Have you seen this man?',
        'summary' => ':age years old. Dutch. Missing in Istanbul since :date.',
        'day_badge' => 'Day :count',
        'since_badge' => 'Since :date',
        'cta_tip' => 'I have information',
        'emergency_prompt' => 'Is he in danger or hurt?',
        'emergency_action' => 'Call :number',
    ],
    ...
    'values' => [
        ...
        'hair' => [
            'blond_thinning' => 'Short dark-blond hair, thinning and receding at the temples',
        ],
        'eyes' => [
            'blue_grey' => 'Blue-grey',
        ],
        'languages' => [
            'nl' => 'Dutch',
            'en' => 'English',
            'ru_basic' => 'Russian (basic)',
        ],
        'phone' => [
            'off_since' => 'His phone has been off since 3 August. It no longer rings when called, and messages are not delivered.',
        ],
    ],
    ...
    'contact' => [
        'emergency_title' => 'If he is in danger or needs urgent help',
        ...
        'case_reference' => 'Police reference',
    ],

    'scam' => [
        'title' => 'No payment for information',
        'body' => 'Every tip goes to the police, and Oscar\'s family does not pay for information. If anyone asks you for money in exchange for news about him, please report that to the police.',
    ],

    'share' => [
        'body' => 'One person recognising this face is all it takes. Sharing this page with people in Istanbul helps the most.',
        'copy' => 'Copy link',
        'copied' => 'Link copied',
        'print' => 'Print a poster',
    ],

    'photos' => [
        'passport' => 'Passport photo',
        'summer' => 'In summer clothing',
        'jacket' => 'In a winter jacket',
    ],

    'footer' => [
        'updated' => 'Last updated :date',
        'switch' => 'Read this page in another language',
    ],
